#include "SemanticWordNet.hpp"

std::mutex SemanticWordNet::wn_mtx;
std::mutex SemanticWordNet::sns_mtx;
std::mutex SemanticWordNet::delta_mtx;
std::mutex SemanticWordNet::save_mtx;
